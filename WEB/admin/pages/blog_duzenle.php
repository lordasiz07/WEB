...
<head>
    ...
    <title>Blok Düzenle | Panel</title>
...
<body>
    ...
    if(@$_POST["submit"]){
        ...
        $guncelle =$db->prepare("UPDATE `blog` SET `baslik` =:baslik,`alt_baslik`=:alt, `aciklama`=:aciklama,`aktif`=:aktif WHERE `id`=:id");
                                ...
                                <div class="col-lg-6">
                                    <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label>Başlık</label>
                                            <input class="form-control" name="baslik" value="<?=$row["baslik"] ?>" placeholder= "Enter text">"
                                        </div>
                                        <div class="form-group">
                                            <label>Alt Başlık</label>
                                            <input class="form-control" name="alt_baslik" value="<?=$row["alt_baslik"] ?>"placeholder= "Enter text">
                                        </div>
