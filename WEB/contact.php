      ...
      <div class="row">
        <div class="col-lg-8 col-md-10 mx-auto">
          <div class="page-heading">
            <h1>İLETİŞİM</h1>
            <span class="subheading">Bize Yazın!</span>
          </div>
        </div>
      </div>
    </div>
        ...
        <form method="POST" name="sentMessage">
          ...
          <div class="control-group">
            <div class="form-group floating-label-form-group controls">
              ...
              <input type="email" class="form-control" placeholder="E-mail Adres" id="email" required data-validation-required-message="Please enter your email address.">
              <p class="help-block text-danger"></p>
            </div>
          </div>
          <div class="control-group">
          ...
          <br>
          <div id="success"></div>
          <input type="submit" name="submit" ,id="sendMessageButton" class="btn btn-primary" value= "Gönder">
        </form>
      </div>
    </div>
  </div>
